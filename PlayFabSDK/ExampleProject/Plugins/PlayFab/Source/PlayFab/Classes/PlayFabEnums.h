...
enum class EGameBuildStatus : uint8
{
    ...
    InvalidBuildPackage UMETA(DisplayName = "InvalidBuildPackage"),
    Processing UMETA(DisplayName = "Processing"),
    FailedToProcess UMETA(DisplayName = "FailedToProcess"),
};
...
{
    ItemId UMETA(DisplayName = "ItemId"),
    TableId UMETA(DisplayName = "TableId"),
};
...
{
    NotScheduled UMETA(DisplayName = "NotScheduled"),
...
enum class EPlayerConnectionState : uint8
{
    ...
    Participating UMETA(DisplayName = "Participating"),
    Participated UMETA(DisplayName = "Participated"),
