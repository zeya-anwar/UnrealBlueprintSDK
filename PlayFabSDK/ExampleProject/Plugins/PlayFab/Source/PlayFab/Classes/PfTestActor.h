...
public:
    ...
    /// </summary>
    UFUNCTION()
        void UserStatisticsApi(UPfTestContext* testContext);
    UFUNCTION()
        void OnUserStatisticsApiGet1(FClientGetUserStatisticsResult result, UObject* customData);
    UFUNCTION()
        void OnUserStatisticsApiUpdate(FClientUpdateUserStatisticsResult result, UObject* customData);
    UFUNCTION()
        void OnUserStatisticsApiGet2(FClientGetUserStatisticsResult result, UObject* customData);
    bool TryExtractIntFromStats(const UPlayFabJsonObject* jsonObj, const FString& key, int& outValue);
