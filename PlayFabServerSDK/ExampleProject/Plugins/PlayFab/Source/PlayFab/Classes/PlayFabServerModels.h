...
USTRUCT(BlueprintType)
struct FServerGetCloudScriptUrlRequest
{
    GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct FServerGetCloudScriptUrlResult
{
    GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct FServerRunCloudScriptResult
{
    GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct FServerRunServerCloudScriptRequest
{
    GENERATED_USTRUCT_BODY()
